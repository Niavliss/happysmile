...
@section('content')
    ...
    <div class="container" id="container-cgu">
        <div class="row">
            <span>
                <h2 id="title-cgu">Conditions Générales d'Utilisation</h2>
            ...
            <a href="/"><button class="btn btn-warning btn-sm" id="retour-accueil">Retour à l'accueil</button></a>
